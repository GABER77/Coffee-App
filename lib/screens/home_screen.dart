import 'package:advanced_coffee/components/spaces.dart';
import 'package:advanced_coffee/models/cart_model.dart';
import 'package:advanced_coffee/models/side_list_model.dart';
import 'package:advanced_coffee/screens/item_screen.dart';
...
String? SelectedType = SideMenu.mySideMenu[0].name;
...
class _HomeScreenState extends State<HomeScreen> {
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: ListView.separated(
                      itemBuilder: (context, index) => SideList(SideMenu.mySideMenu[index]),
                      separatorBuilder: (context, index) => SizedBox(
                        height: 22.h,
                      ),
                      itemCount: SideMenu.mySideMenu.length,
                    ),
                  ),
                ),
                Spacer(),
  ...
  Widget SideList(SideMenu menuSideList) => RotatedBox(
        quarterTurns: 3,
        child: InkWell(
          onTap: () {
            setState(() {
